        ...
        <div class="card-item">
            <form method="POST" action="?p=cadastro-usuario&acao=cadastrar">
                ...
                <div class="campo-form">
                    ...
                    <input type="text" id="nome" name="nome" class="input-dark"
                ...
                <div class="campo-form">
                    ...
                    <input type="text" id="cpf" name="cpf" class="input-dark"
                ...
                <div class="campo-form">
                    ...
                    <input type="password" id="confirmar" name="confirmar" class="input-dark"
                        placeholder="Repita a senha" required>
                </div>

                <button type="submit" class="btn" style="width:100%; margin-top:4px;">Criar conta</button>
            </form>

            <p style="margin-top:18px; color:var(--texto-secundario); font-size:.9rem;">
                Já tem uma conta?
